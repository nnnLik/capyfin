...
class ApplicationSettings(BaseSettings):
    ...
    CORS_ALLOWED_ORIGINS: list[str] = Field(["https://ef97-87-200-80-188.ngrok-free.app", 'http://localhost:8012'])
    CSRF_TRUSTED_ORIGINS: list[str] = Field(["https://ef97-87-200-80-188.ngrok-free.app", 'http://localhost:8012'])
